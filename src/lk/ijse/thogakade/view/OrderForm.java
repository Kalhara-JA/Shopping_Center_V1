...
public class OrderForm extends javax.swing.JFrame {
    ...
    private void cmbCustomerIdItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cmbCustomerIdItemStateChanged
        try {
            ...
            if(c1!=null){
                ...
                JOptionPane.showMessageDialog(this,"Empty Result");
            }
        } catch (ClassNotFoundException | SQLException ex) {
            Logger.getLogger(OrderForm.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void cmbItemCodeItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cmbItemCodeItemStateChanged
        try {
            Item i1=ItemController.searchItem(cmbItemCode.getSelectedItem().toString());
            if (i1!=null){
                lblDescription.setText(i1.getDescription());
                lblUnitPrice.setText(String.valueOf(i1.getUnitPrice()) );
...
//        txtOrderDate.setText(dateText);
    ...
    private void loadItemCodes() throws ClassNotFoundException, SQLException {
